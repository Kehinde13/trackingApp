...
export async function getShipmentDetails(id: string) {
  return prisma.shipment.findUnique({
    ...
    select: {
      ...
      providerCarrierCode: true,
      carrierConnectionStatus: true,
      carrierRegisteredAt: true,
      carrierLastSuccessfulSyncAt: true,
      carrierLastErrorCode: true,
      carrierLastErrorAt: true,
      status: true,
      originCity: true,
